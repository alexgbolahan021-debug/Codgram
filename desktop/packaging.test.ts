...
const manifest = JSON.parse(readFileSync(packagePath, "utf8")) as {
  ...
  build?: { appId?: string; productName?: string; mac?: { target?: string[] }; win?: { target?: Array<{ target: string; arch: string[] }>; signtoolOptions?: { publisherName?: string } }; linux?: { target?: string[] } };
